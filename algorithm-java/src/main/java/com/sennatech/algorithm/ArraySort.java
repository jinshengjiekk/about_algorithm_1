...
public class ArraySort {
    ...
    public static void main(String[] args) {
        ...
        printArray(arrayInt);
        logger.info("快速排序用时===========>>> {}" + (System.currentTimeMillis() - start) + "毫秒");
    }
}
